            ...
            <div class="col-md-8 bg-white p-0">
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><span class="underline text-gray-900 dark:text-white">Add New Device</span></div>
                    </div>
                    ...
                    <div class="content">
                        <div class="card">
                            <div class="card-body">
                                {!! Form::open(['route' => 'device.store', 'class' => 'form-horizontal']) !!}

                                    <div class="form-group">
                                        <div class="row">
                                            {!! Form::label('device_number', 'Device Node:',['class'=>'col-md-4 col-lg-4 col-12 control-label']) !!}
                                            <div class="col-md-8 col-lg-8 col-12">
                                                <input type="text" class="form-control" name="device_number">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-lg-8 col-12">
                                                <input type="text" class="form-control" name="device_port">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-lg-8 col-12">
                                                <input type="text" class="form-control" name="device_public_ip">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-lg-8 col-12">
                                                <input type="text" class="form-control" name="device_public_port">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-lg-8 col-12">
                                                <input type="text" class="form-control" name="device_serial_number">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-lg-8 col-12">
                                                <input type="text" class="form-control" name="device_machine_no">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-lg-8 col-12">
                                                <input type="text" class="form-control" name="device_install_location">
                                            </div>
                                        </div>
                                    </div>
