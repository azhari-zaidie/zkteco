...
Route::get('/device-data/{id}', [MachineController::class, 'device_data'])->name('machine.devicedata');
...
Route::get('/device-data/export', [MachineController::class, 'device_data_export'])->name('machine.devicedata.export'); //export data into txt

// Route::resource('devices', 'DeviceController');
Route::get('/device-addnew', [DeviceController::class, 'create'])->name('device.create');
Route::any('/device-storedata', [DeviceController::class, 'store'])->name('device.store');
Route::any('/device-display-all', [DeviceController::class, 'index'])->name('device.index');
Route::any('/device-delete', [DeviceController::class, 'destroy'])->name('device.destroy');
Route::any('/device-edit/{id}', [DeviceController::class, 'edit'])->name('device.edit');
Route::any('/device-update-data/{id}', [DeviceController::class, 'update'])->name('device.update');